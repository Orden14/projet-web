...
export function setModalDates(startDate, endDate) {
    $('#manageEventModal input[name="calendar_event[start]"]').val(format(startDate, "yyyy-MM-dd HH:mm"));
    $('#manageEventModal input[name="calendar_event[end]"]').val(format(endDate, "yyyy-MM-dd HH:mm"));
}
